...
aws cloudformation update-stack --stack-name white-service --template-body file://ci/ecs.yaml || aws ecs update-service --cluster white-service-cluster --service white-service --force-new-deployment --region ap-southeast-2
